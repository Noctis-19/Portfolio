...
export default function FormationModal({ formation, onClose, onNext, onPrev }) {
            ...
            <div ref={modalRef} className="bg-gray-900 rounded-lg max-w-4xl w-11/12 max-h-[90vh] overflow-y-auto p-12 pr-15 pl-15" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="space-y-4 md:w-1/2">
                        ...
                        <p className="text-gray-300">{formation.fullDescription}</p>
                        <div>
                            <h3 className="font-semibold mb-2 text-blue-600">
                                Tech Stack:
                            </h3>
                            <ul className="list-disc list-inside">
                                {formation.techStack.map((tech, index) => (
