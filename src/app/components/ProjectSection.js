...
const ProjectSection = () => {
    const projects = [
        ...
        },
        {
            ...
            fullDescription: "Le site a pour but d'être utilisé et maintenu par quelqu'un qui ne maitrise pas l'informatique d'où le choix du headless CMS avec Strapi qui est open-source.",
            image: "/siteUSCS.png",
            status: {icon: Check, color: "green", text: "Terminé"},
